...
- (nonnull instancetype)initWithUserUuid:(NSString * _Nonnull)userUuid timestamp:(NSInteger)timestamp messageId:(NSInteger)messageId pushTitle:(NSString * _Nonnull)pushTitle pushBody:(NSString * _Nonnull)pushBody url:(NSString * _Nonnull)url readStatus:(BOOL)readStatus OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// returns:
/// No return value.
- (void)registerTokenWith:(NSData * _Nonnull)data;
...
- (void)getNoticesWith:(NSString * _Nullable)messageID and:(NSString * _Nullable)userUUID completion:(void (^ _Nonnull)(AVPNoticesResponse * _Nullable))completion;
...
///   </li>
/// </ul>
- (void)setNoticeReadWith:(NSInteger)id;
